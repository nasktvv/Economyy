    ...
    .setDescription(`<:dollarmoney:814776832779354132> **Você precisa de  5000₦ animes para comprar a função de *Amador***`)
     ...
     let Embed2 = new Discord.MessageEmbed()
       ...
       if (author < pepa) return message.channel.send(Embed2)(Embed2)
        ...
        .setColor("#7500ff")
        .setTitle('Mangás Insuficente <:emoji_67:831362443656822854> <a:grr:831992644317216778>')
        .setDescription(`<:purple_chorando:832002026145448047> **Você precisa de 2₪ mangás para comprar uma *Isca de waifus***`)
         .setFooter("・Purple's Commands", message.author.displayAvatarURL({format: "png"}))
       ...
       db.add(`isca_${message.guild.id}_${user.id}`, 1)
        ...
        .setColor("#7500ff")
        .setTitle('Compra efetuada <:emoji_67:831362443656822854> <a:pr_check02:831327513094651924>')
        .setDescription(`<:purple_uau:832003077883297843> **Você comprou uma isca de *waifus***`)
